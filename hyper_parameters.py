...
a random batch''')
tf.app.flags.DEFINE_integer('train_batch_size', 14, '''Train batch size''')
tf.app.flags.DEFINE_integer('test_size',14, '''Train batch size''')
tf.app.flags.DEFINE_integer('validation_batch_size', 14, '''Validation batch size, better to be
a divisor of 10000 for this task''')
tf.app.flags.DEFINE_integer('test_batch_size',14, '''Test batch size''')
...
tf.app.flags.DEFINE_string('ckpt_path', 'mydata/Train/model.ckpt-24000', '''Checkpoint
directory to restore''')
tf.app.flags.DEFINE_boolean('is_use_ckpt', False, '''Whether to load a checkpoint and continue
training''')

tf.app.flags.DEFINE_string('test_ckpt_path', 'mydata/Train/model.ckpt-24000', '''Checkpoint
directory to restore''')
